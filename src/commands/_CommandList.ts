...
export const CommandList: Command[] = [boost, profile, battle, raid, boostxp, boostmobcoin, armor, weapon, pet, skill, shop, buy, hitman, mademan, flokimusk, bullduck, donfather, info ];